...
2017.9.30晚上收到录用意向通知，后端开发sp。美团的面试体验非常棒，面试官很专业且都人很nice！
...
一面（技术面，视频面，2017.9.6 中午）
  ...
  ● 说说SVM
      ...
      ○ 讲SVM的推导过程：SVM的原理，函数间隔和几何间隔，目标函数的等价转换，拉格朗日乘子法，原始问题和对偶问题，KKT条件，SMO算法等
      ○ 如何选择核函数
...
二面（技术面，视频面，2017.9.6 下午）
  ...
  ● LR原理
  ● LR如何实现并行
  ● 特征工程，为什么LR中要做特征离散化，特征离散化有什么好处，最核心的功能是什么
  ● 了解哪些优化算法
...
三面 （技术面，现场面，杭州西湖区，2017.9.23 下午）
  ...
  ● 聊组合优化/连续优化
  ● 聊VRP, TSP
  ● 带业务场景的算法题：设有一辆车，此时有4个乘客发出乘车请求，计算最佳载客路线，最小化路程；如果不止4个乘客，n个呢？
...
四面（HR面，现场面，杭州西湖区，2017.9.23 下午）
  ● （开始十几秒见HR姐姐没说话，我说要不我先做个自我介绍，姐姐很干脆地回应不用这么正式）
...
最后我选择了网易。结果只有一个，然而选择的过程却是艰难的，因为你不可能完全预测每一个选择对未来发展轨迹的影响。「为什么」，人总是喜欢问为什么，我在[这里](http://ihuafan.com/%E9%9A%8F%E7%AC%94/summary-of-2017#%E6%B1%82%E8%81%8C)有简单的解释。
